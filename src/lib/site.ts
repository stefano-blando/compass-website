  ...
  en: {
    hero: {
      ...
      marqueeItems: [
        ...
        { label: 'Thematic Panel', eyebrow: 'Track dialogue' },
        { label: 'Historic Campus', eyebrow: 'Sant’Anna' },
        { label: 'Scientific Roundtable', eyebrow: 'Workshop exchange' },
        { label: 'Invited Experts', eyebrow: 'Guest speakers' },
      ],
    ...
    darkStage: {
      ...
      intro:
        'COMPASS is staged as a full-day sequence of keynote framing, doctoral-led panels, and roundtable discussion. The workshop fosters interdisciplinary dialogue in a unified scientific setting.',
      videoLabel: 'Workshop Venue',
    ...
    registration: {
      ...
      title: 'Register for a compact, free workshop format.',
      intro:
  ...
  it: {
    hero: {
      ...
      marqueeItems: [
        ...
        { label: 'Panel Tematico', eyebrow: 'Dialogo di track' },
        { label: 'Campus Storico', eyebrow: 'Sant’Anna' },
        { label: 'Tavola Rotonda Scientifica', eyebrow: 'Scambio workshop' },
        { label: 'Esperti Invitati', eyebrow: 'Ospiti esterni' },
      ],
    ...
    darkStage: {
      ...
      title: 'Ricerca, diritto, policy e AI in una singola intensa giornata.',
      intro:
        'COMPASS è strutturato come una sequenza di keynote, panel guidati da dottorandi e tavole rotonde. Il workshop favorisce il dialogo interdisciplinare in un contesto scientifico unitario.',
      videoLabel: 'Sede del workshop',
      videoTitle: 'Aula 3, Scuola Superiore Sant’Anna',
    ...
    registration: {
      ...
      title: 'Partecipa a un workshop gratuito e raccolto.',
      intro:
      ...
      checklist: [
        ...
        'Completa il modulo per confermare la presenza',
      ],
