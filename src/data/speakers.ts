...
export const speakers: Speaker[] = [
  {
    ...
    roleLabel: {
      en: 'Workshop Chair',
      it: 'Chair del Workshop',
    },
    bio: {
      en: 'Andrea Vandin is an Associate Professor of Computer Science at the Sant’Anna School of Advanced Studies, where he leads research on formal methods and software engineering applied to complex systems.',
      it: 'Andrea Vandin è Professore Associato di Informatica presso la Scuola Superiore Sant’Anna, dove guida la ricerca sui metodi formali e l’ingegneria del software applicata ai sistemi complessi.',
    },
    type: ['institutional'],
  },
  {
    slug: 'rettore-sssa',
    name: 'Rector of Scuola Superiore Sant’Anna',
    affiliation: {
      en: 'Scuola Superiore Sant’Anna',
      it: 'Scuola Superiore Sant’Anna',
    },
    roleLabel: {
      en: 'Institutional Greeting',
      it: 'Saluti istituzionali',
    },
    bio: {
      en: 'Institutional greetings on behalf of Scuola Superiore Sant’Anna.',
