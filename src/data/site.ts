  ...
  en: {
    ...
    faq: {
      hero: {
        ...
        intro: 'Practical details on registration, logistics, and workshop attendance to help you plan your visit to Pisa.',
      ...
      sections: [
        ...
        },
        {
          ...
          body: 'The workshop is held in central Pisa. We recommend booking accommodation early as May is a busy month for the city.',
          ...
          bullets: [
            ...
            'Hotels: Several options are available within walking distance from the campus.',
          ],
        },
        {
          eyebrow: 'Materials',
  ...
  it: {
    ...
    faq: {
      hero: {
        ...
        intro: 'Dettagli pratici su registrazione, logistica e partecipazione al workshop per aiutarti a pianificare la tua visita a Pisa.',
      ...
      sections: [
        ...
        },
        {
          ...
          body: 'Il workshop si svolge nel centro di Pisa. Consigliamo di prenotare l’alloggio con anticipo dato che maggio è un mese di alta affluenza per la città.',
          ...
          bullets: [
            ...
            'Hotel: Numerose opzioni disponibili a pochi passi dal campus.',
          ],
        },
        {
          eyebrow: 'Materiali',
