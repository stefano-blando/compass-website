...
export const sessions: Session[] = [
  {
    ...
    description: {
      en: 'Andrea Vandin opens the workshop day and frames the agenda in Aula 3 at Scuola Superiore Sant’Anna.',
      it: 'Andrea Vandin apre la giornata e inquadra l agenda del workshop in Aula 3 alla Scuola Superiore Sant’Anna.',
    },
    type: 'opening',
  ...
  },
  {
    ...
    description: {
      en: 'Working panel title from the workshop PDF. The current lineup follows the latest agenda, including two open speaker slots and a roundtable close.',
      it: 'Titolo provvisorio tratto dal PDF del workshop. La scaletta attuale segue l agenda piu recente, incluse due slot speaker aperte e una roundtable finale.',
    },
    type: 'panel',
  ...
  },
  {
    ...
    description: {
      en: 'Working panel title from the workshop PDF, with the current six-item afternoon lineup ending in a roundtable.',
      it: 'Titolo provvisorio tratto dal PDF del workshop, con la scaletta pomeridiana attuale di sei interventi e roundtable finale.',
    },
    type: 'panel',
  ...
  },
  {
    ...
    description: {
      en: 'Working panel title from the workshop PDF. The current lineup includes one open speaker slot and closes with a roundtable.',
      it: 'Titolo provvisorio tratto dal PDF del workshop. La scaletta attuale include uno slot speaker aperto e si chiude con una roundtable.',
    },
    type: 'panel',
